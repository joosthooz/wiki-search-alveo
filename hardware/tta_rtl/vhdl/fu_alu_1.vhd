...
begin
  ...
  operations_actual_cp : process(load_in1t_in, data_in1t, gt_op2, eq_op2, eq_op1, operation_in, ior_op1, data_in2, shru_op1, sub_op1, shr_op2, ne_op1, and_op1, shru_op2, shr_op1, sub_op2, ior_op2, shl_op1, gt_op1, gtu_op2, ne_op2, and_op2, add_op2, shl_op2, add_op1, gtu_op1)
  begin
    sub_op3 <= (others => '-');
    sub_op1 <= data_in1t;
    sub_op2 <= data_in2;
    shru_op3 <= (others => '-');
    shru_op1 <= data_in2;
    shru_op2 <= data_in1t(4 downto 0);
    shr_op3 <= (others => '-');
    shr_op1 <= data_in2;
    shr_op2 <= data_in1t(4 downto 0);
    shl_op3 <= (others => '-');
    shl_op1 <= data_in2;
    shl_op2 <= data_in1t(4 downto 0);
    ne_op3 <= '-';
    ne_op1 <= data_in2;
    ne_op2 <= data_in1t;
    and_op3 <= (others => '-');
    ...
    if (load_in1t_in = '1') then
      case operation_in is
        ...
        when op_shl_c =>
          shl_op3 <= std_logic_vector(shift_left(unsigned(shl_op1), to_integer(unsigned(shl_op2))));
        when op_shr_c =>
          shr_op3 <= std_logic_vector(shift_right(signed(shr_op1), to_integer(unsigned(shr_op2))));
        when op_shru_c =>
          shru_op3 <= std_logic_vector(shift_right(unsigned(shru_op1), to_integer(unsigned(shru_op2))));
        when op_sub_c =>
